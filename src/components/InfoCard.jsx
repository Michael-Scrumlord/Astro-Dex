...
export default function InfoCard(props) {
  ...
  function openForm() {
    ...
    return(
        document.getElementById("closeCardButton").style.display = "inline-block"
    )
  }
  ...
  function closeForm() {
    ...
    return(
      document.getElementById("openCardButton").style.display="inline-block"
      )
  }
    ...
    <Html position={props.position}>
      <div className="InfoCard" id="infoCard">
        <div id="expandedInfoCard">
          ...
          <button className="InfoCardMinimize" 
                onClick={closeForm}
                id="closeCardButton"                
                ><span></span><span></span></button>
        </div>
        <button className="InfoCardMaximize"
                onClick={openForm}
                id="openCardButton"
                ><span></span><span></span></button>
      </div>
